...
import co.ledger.cria.domain.adapters.persistence.lama.queries.{OperationQueries, TransactionQueries}
...
final class WDServiceImpl(db: Transactor[IO], transactionService: TransactionService) extends WDService {
